show databases;
create database toshin_banking;
use toshin_banking;
grant all privileges on*.* to 'toshin' with grant option;
show databases;
create table branch(
...
insert into bank_customer values('umang','indranagar','bombay');
...
insert into bank_customer values('manu','basavangud','bangalore');
...
insert into depositor values('umang',1);
